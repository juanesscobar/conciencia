"""Google adapter — Gemini models (OpenAI-compatible API)."""
...
class GoogleAdapter(ProviderAdapter):
    """Google provider adapter (Gemini models via OpenAI-compatible API)."""
    ...
    def get_pricing(self, model: str) -> Dict[str, float]:
        ...
        return pricing or self.PRICING["gemini-2.0-flash"]
